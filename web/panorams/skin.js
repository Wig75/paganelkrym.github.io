...
// Pano2VR 3.1.2/1855
// Filename: paganelkrym.ggsk
// Generated Пт 13. окт 16:11:17 2017
...
function pano2vrSkin(player,base) {
	...
	this.preloadImages=function() {
		...
		preLoadImg.src=basePath + 'images/paganelkrymru__o.png';
		preLoadImg.src=basePath + 'images/paganelkrymru__a.png';
	}
	...
	this.addSkin=function() {
		...
		this._paganelkrymru=document.createElement('div');
		this._paganelkrymru.ggId='paganelkrym.ru'
		this._paganelkrymru.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._paganelkrymru.ggVisible=true;
		hs ='position:absolute;';
		hs+='left: 0px;';
		hs+='top:  0px;';
		hs+='width: 245px;';
		...
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._paganelkrymru.setAttribute('style',hs);
		this._paganelkrymru__img=document.createElement('img');
		this._paganelkrymru__img.setAttribute('src',basePath + 'images/paganelkrymru.png');
		this._paganelkrymru__img.setAttribute('style','position: absolute;top: 0px;left: 0px;');
		me.player.checkLoaded.push(this._paganelkrymru__img);
		this._paganelkrymru.appendChild(this._paganelkrymru__img);
		this._paganelkrymru.onclick=function () {
			me.player.openUrl("http:\/\/paganelkrym.ru\/residence1.php","_self");
		}
		this._paganelkrymru.onmouseover=function () {
			me._paganelkrymru__img.src=basePath + 'images/paganelkrymru__o.png';
		}
		this._paganelkrymru.onmouseout=function () {
			me._paganelkrymru__img.src=basePath + 'images/paganelkrymru.png';
		}
		this._paganelkrymru.onmousedown=function () {
			me._paganelkrymru__img.src=basePath + 'images/paganelkrymru__a.png';
		}
		this._paganelkrymru.onmouseup=function () {
			me._paganelkrymru__img.src=basePath + 'images/paganelkrymru.png';
		}
		this.__33=document.createElement('div');
		this.__33.ggId='\u041a\u043e\u043d\u0442\u0435\u0439\u043d\u0435\u0440 33'
		...
		this._paganelkrymru.appendChild(this.__33);
		this.divSkin.appendChild(this._paganelkrymru);
		this.preloadImages();
